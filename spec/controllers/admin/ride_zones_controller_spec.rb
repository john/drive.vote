...
RSpec.describe Admin::RideZonesController, type: :controller do
  ...
  describe "POST #create" do
    ...
    #     post :create, params: {ride_zone: invalid_attributes}
    #     expect(assigns(:ride_zone)).to be_a_new(RideZone)
    #   end
    #
...
#         put :update, params: {id: ride_zone.to_param, ride_zone: new_attributes}
#         ride_zone.reload
...
#       it "assigns the requested ride_zone as @ride_zone" do
#         ride_zone = RideZone.create! valid_attributes
#         put :update, params: {id: ride_zone.to_param, ride_zone: valid_attributes}
#         expect(assigns(:ride_zone)).to eq(ride_zone)
#       end
#
...
#         ride_zone = RideZone.create! valid_attributes
#         put :update, params: {id: ride_zone.to_param, ride_zone: invalid_attributes}
#         expect(assigns(:ride_zone)).to eq(ride_zone)
#       end
#
